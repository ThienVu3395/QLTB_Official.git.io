...
(function () {
    ...
    .controller('viewfilewordCtrl', ["$scope", "$http", "$sce", "$uibModalInstance", "appSettings", "loginservice", "userProfile", "idselect",
function ($scope, $http,$sce, $uibModalInstance, appSettings, loginservice, userProfile, idselect) {
    var $ctrl = this;
