        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                var poller = $interval(function () {
                    ...
                    $scope.updateFn()(pdfViewer.currentPageNumber);
                }, 200);
                ...
                $scope.$watch(function () {
                    return $scope.pageview;
                }, function () {
                    if (window.PDFViewerApplication.pdfViewer) {
                        if ($scope.pageview > 0)
                            if (window.PDFViewerApplication.pdfViewer.currentPageNumber != $scope.pageview)
                                window.PDFViewerApplication.pdfViewer.currentPageNumber = $scope.pageview;
                    }
